...
lyr_Positron_0.setVisible(true);lyr_Nezahualcoyotl_1.setVisible(true);lyr_colonias_2.setVisible(true);
var layersList = [lyr_Positron_0,lyr_Nezahualcoyotl_1,lyr_colonias_2];
