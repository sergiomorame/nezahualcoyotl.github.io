...
map.getView().fit([-11039481.838072, 2197714.113777, -11005524.113188, 2214127.224282], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Incidencias del Agua Nezahualcoyotl</h2>';
        return titleElement;
    })(),
